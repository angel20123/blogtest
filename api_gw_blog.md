...
### Zuul 관련 이슈 사항
아래 모듈들은 Spring 2.4 버전부터(# Spring Cloud 2020.0 Release Notes) 확정된 내용입니다. Netflix 사에서 유지보수 개발만 진행되는 라이브러리에 대해서 Spring에서 지원하지 않겠다고 발표하였습니다. 따라서 Spring 2.4 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTQ0Nzc0NTA0LDI3MTM3ODQwNiw1NDgxMT
